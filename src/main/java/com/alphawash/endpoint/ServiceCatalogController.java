...
public class ServiceCatalogController {
    ...
    public ResponseEntity<List<ServiceCatalogResponse>> getAll() {
        return ResponseEntity.ok(
                ServiceCatalogConverter.INSTANCE.toResponse(service.getAll()));
    }
...
//    public ResponseEntity<ServiceCatalogResponse> update(@PathVariable Long id, @RequestBody ServiceCatalogRequest request) {
//        ServiceCatalogDto dto = ServiceCatalogConverter.INSTANCE.fromRequest(request);
